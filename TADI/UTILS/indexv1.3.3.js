...
require(['N/https', 'N/url', 'N/currentRecord', "N/runtime"], (https, url, cr, runtime) => {
    ...
    let docValueColumns = {
        title: " ", field: "to", editor: "textarea", validator: '', editable: false, headerFilter: "", width: 170, minWidth: 169, maxWidth: 171, formatter: transferorderFormatter, tooltip: 'Vedi Documento'
    };
