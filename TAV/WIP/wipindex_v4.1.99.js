...
require(['N/https', 'N/url', 'N/search'], (https, url, search) => {
    ...
    let accountColumns = {
        title: "Conto Magazzino", field: "account", editor: "textarea", validator: '', width: 450, minWidth: 200, maxWidth: 500, editable: false, headerFilter: "input", formatter: stdFormatter, tooltip: 'Magazzino/Location'
    };
